...
// Keeps track of which tab is currently active: "all", "interview", "rejected"
let currentTab = "all";

// Main data source: all job objects live here
const jobs = [
  {
  ...
  {
    id: 4, position: "Mobile App Developer",
  ...
  },
  {
    ...
    location: "Boston, MA",
    type: "Full-time", salary: "$80,000 - $100,000",
...
// Returns the main container where job cards will be rendered
